...
import com.example.demo.CarRentalService.model.Car;
import com.example.demo.CarRentalService.model.Customer;
...
public abstract class Transaction {
    ...
    public abstract boolean delistResource(XAResource xaResource, int i) throws IllegalStateException, SystemException;

    public abstract boolean enlistResource(XAResource xaResource) throws RollbackException, IllegalStateException, SystemException;

    public abstract int getStatus() throws SystemException;

    public abstract void registerSynchronization(Synchronization synchronization) throws RollbackException, IllegalStateException, SystemException;
